...
| RNF-004 | Peso de JavaScript por rota de calculadora | **≤ 150 KB comprimido**, e **≤ 30 KB de parte variável** por calculadora | Orçamento verificado no CI, por calculadora publicada |
