  ...
  return {
    ...
    valores: {
      ...
      detalhamento: [
        ...
        { rotulo: 'Multa de 40% do FGTS', valor: v.multaFgts, sinal: 'credito' },
...
export const RESCISAO_SEM_JUSTA_CAUSA: DefinicaoCalculadora = {
  ...
  campos: [
    ...
    },
    {
      ...
      ajuda: 'Indenizado é o mais comum: você é dispensado e não cumpre o período.',
    },
    {
      id: 'feriasVencidas',
    ...
    },
    {
      ...
      minimo: 0,
      maximo: 100_000_000,
      ajuda: 'Deixe em branco para estimar. O valor exato está no extrato da conta vinculada.',
    },
    {
      id: 'dependentes',
  ...
  faq: [
    ...
    {
      pergunta: 'Por que o valor da multa do FGTS pode não bater com o meu extrato?',
      resposta:
  ...
  relacionadas: ['salario-liquido', 'inss', 'irrf'],
}
